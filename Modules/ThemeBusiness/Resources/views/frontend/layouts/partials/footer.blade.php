              ...
              <div class="col-md-4 col-lg-2 mb-4 mb-md-0">
                  ...
                  <ul class="list-unstyled mb-0">
                      @foreach ($services as $service)
                          <li class="mb-1">
                              <a href="{{ route('demo.business.poetry.show', $service->slug) }}">
                                  {{ $service->title }}
                              </a>
                          </li>
                      @endforeach
                  ...
                  <a href="{{ route('demo.business.service') }}"
                      class="btn btn-link font-weight-bold text-decoration-none ps-0">Xem Thêm</a>
              </div>
              <div class="col-md-4 col-lg-2 mb-4 mb-md-0">
                  <h4 class="font-weight-bold ls-0">About</h4>
                  <ul class="list-unstyled mb-0">
                      <li class="mb-1">
                          <a href="{{ route('demo.business.about') }}">About Us</a>
                      </li>
                      <li class="mb-0">
                          <a href="{{ route('demo.business.contact') }}">Send a Message</a>
                      </li>
                  </ul>
              </div>
