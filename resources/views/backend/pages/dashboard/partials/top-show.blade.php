                    ...
                    <div class="col-md-12">
                        <div class="d-flex no-block align-items-center pointer" onclick="location.href='{{ route('admin.admins.index') }}'">
                            <div>
                                ...
                                <p class="font-16 m-b-5">Số Lượng Admins</p>
                            </div>
                            <div class="ml-auto">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex no-block align-items-center pointer" onclick="location.href='{{ route('admin.roles.index') }}'">
                            <div>
                                <i class="mdi mdi-account font-20 text-muted"></i>
                                <p class="font-16 m-b-5">Số Lượng Roles</p>
                            </div>
                            <div class="ml-auto">
                ...
                <div class="col-md-12">
                    <div class="d-flex no-block align-items-center pointer" onclick="location.href='{{ route('admin.categories.index') }}'">
                        <div>
                            ...
                            <p class="font-16 m-b-5">Số Lượng  Categories</p>
                        </div>
                        <div class="ml-auto">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex no-block align-items-center pointer" onclick="location.href='{{ route('admin.pages.index') }}'">
                            <div>
                                <i class="mdi mdi-tune font-20 text-muted"></i>
                                <p class="font-16 m-b-5">Tổng Tác Phẩm / Pages</p>
                            </div>
                            <div class="ml-auto">
    ...
    @if ($user->can('author.view'))
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex no-block align-items-center pointer" onclick="location.href='{{ route('admin.authors.index') }}'">
                            <div>
                                <i class="mdi mdi-tune font-20 text-muted"></i>
                                <p class="font-16 m-b-5">Số Lượng  Blogs</p>
                            </div>
                            <div class="ml-auto">
